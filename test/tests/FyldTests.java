...
public class FyldTests {
    ...
    public void addDestillatTest() {
        ...
        fyld.addFad(new Fad(UUID.randomUUID(), FadType.ANDET, "100", 100, 100));
        float mængde = 50;
        ...
        fyld2.addFad(new Fad(UUID.randomUUID(), FadType.ANDET, "100", 100, 75));
        ...
        fyld3.addFad(new Fad(UUID.randomUUID(), FadType.ANDET, "100", 100, 75));
    ...
    public void beregnMængdeTilgængelig() throws Exception {
        // Basis data
        Fad fad = new Fad(UUID.randomUUID(), FadType.ANDET, "100", 100, 50);
        Fyld fyld = new Fyld("Søren");
        fad.setFyld(fyld);
        fyld.addFad(fad);
        fyld.addDestillat(new Destillat(UUID.randomUUID(), 1, "Lars' korn", 100, "Destillering", 48, LocalDate.now(), "Test123"),
